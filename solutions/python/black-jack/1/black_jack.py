...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    if value_of_card(card_one) + value_of_card(card_two) <= 10 and not(card_one == 'A' or card_two == 'A'):
        return 11
    else:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == 'A' and card_two == 'J':
        return True
    elif card_one == 'A' and card_two == 'Q':
        return True    
    elif card_one == 'A' and card_two == 'K':
        return True
    elif card_one == 'J' and card_two == 'A':
        return True
    elif card_one == 'Q' and card_two == 'A':
        return True
    elif card_one == 'K' and card_two == 'A':
        return True
    elif value_of_card(card_one)+value_of_card(card_two)==21:
        return True
    elif card_one == '10' and card_two == 'A':
        return True
    else:
        return False
